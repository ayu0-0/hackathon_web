...
import { Form, MailLoginForm,Confirm } from './components/LoginForm';
...
const Question: React.FC<{ signOut: () => void }> = ({ signOut }) => {
    ...
    const handleFormConfirm = async (email: string) => {
        try {
            ...
            console.error("Error in handleFormConfirm:", error);
        }
                        ...
                        <>
                            <div className="page-container">
                                <div className="form-wrapper">
                                    <Confirm onSubmit={handleFormConfirm} />
                                </div>
                            </div>
                        </>
                    ) : (
